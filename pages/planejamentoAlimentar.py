...
with tab3:
    ...
    • **Chá sem açúcar:** uma opção leve e saudável.
                    ''', icon="🍵")
            st.info(''' **Observações Gerais:**\n 
    • **Café sem açúcar:** pode ser consumido até às 17h.
    
    • **Hidratação:** recomenda-se a ingestão de água até 1 hora antes de dormir.
                    ''', icon="🥤")
            st.info(''' **Importante:**\n 
    Essas práticas auxiliam na manutenção de uma boa higiene do sono, promovendo um descanso de qualidade.
                    ''', icon='⏰')
